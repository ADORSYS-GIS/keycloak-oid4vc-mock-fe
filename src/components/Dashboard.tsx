    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Arial, sans-serif' }}>
      ...
      <aside style={{
        ...
        <div style={{ marginBottom: '40px' }}>
          <h2 style={{ color: '#087ca8', fontSize: '1.2rem', marginBottom: '5px' }}>
            ...
            <li style={{ marginBottom: '10px' }}>
              <button
                ...
                style={{
                  ...
                  padding: '12px 16px',
                  border: 'none',
                  backgroundColor: activeTab === 'mailbox' ? '#fff' : 'transparent',
        ...
        <div style={{ 
          ...
          <a href="#" style={{ color: '#6a2230', marginRight: '8px' }}>Imprint</a>
          <span>·</span>
          <a href="#" style={{ color: '#6a2230', margin: '0 8px' }}>Privacy Policy</a>
          <span>·</span>
          <a href="#" style={{ color: '#6a2230', marginLeft: '8px' }}>Terms of Use</a>
        </div>
      </aside>
          ...
          <div>
            ...
            <div style={{
              ...
              <p style={{ marginBottom: '10px' }}>
                Select <strong>one to a maximum of 10 mailboxes</strong>.
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'start', marginBottom: '15px' }}>
                <input type="checkbox" style={{ marginRight: '12px', marginTop: '4px' }} />
                <div style={{ flex: 1 }}>
              ...
              <div style={{ marginLeft: '28px', fontSize: '0.9rem', color: '#6c757d' }}>
                <p>Safe ID: DE.BStBK_Sandbox.9103746a-ee80-4d3e-a303-7ae2c26bfea1.314a</p>
